...
const config = [
  {
    ...
    firstText: {
      ...
      href: "/product/grower/existing-farmer"
    },
    secondText: [
      { name: "Resources", href: "/product/grower/resources" },
      { name: "Customer stories", href: "/product/grower/customer-stories" },
      { name: "Grower agents", href: "/product/grower/agent" },
      { name: "Farm manager academy", href: "/product/grower/farm-manager-academy" }
    ],
    isHover: false,
  ...
  },
  {
    ...
    firstText: {
      name: "Customer stories",
      href: "/product/buyer/customer-stories"
    },
    secondText: [
      { name: "Resources", href: "/product/buyer/resources" },
      { name: "Sales affiliate", href: "/product/buyer/sales" }
    ],
    activeColor: "#367AFE",
    defaultColor: "#6C6C6C",
    isHover: false,
    ...
    mobileTabs: [
      ...
      {
        name: "Resources",
        href: "/product/buyer/resources"
      },
      {
        name: "Sales affiliate",
        href: "/product/buyer/sales"
      }
    ]
  }
];
...
const BuyerGrowerHeader: React.FC<{ isBuyer: boolean; pathname: string }> = ({ isBuyer, pathname }) => {
      ...
      <div className="sticky top-0 z-50 w-full bg-white lg:border-b lg:border-10 lg:border-[#E6E6E6]">
        <div className="container flex flex-row items-center justify-between mx-auto max-w-7xl">
          <div className="relative flex flex-row mx-5">
            <a className="flex items-center font-medium text-gray-900 lg:w-auto lg:items-center lg:justify-center md:mb-0">
...
export default BuyerGrowerHeader;