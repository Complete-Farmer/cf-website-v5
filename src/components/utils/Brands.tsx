...
export default function Brands({ bgColor, assets }: IProps) {
  return (
    <div className={`${bgColor} py-10 sm:py-14 lg:py-20`}>
      <div className="mx-auto max-w-7xl">
        <p className="text-xl sm:text-2xl font-bold text-center text-custom_green-900 leading-8 mb-6 sm:mb-10">
