      ...
      <div className="relative w-full">
        <div className="block overflow-hidden group rounded-xl relative">
          <img
            ...
            width={event.data.webinar_image.dimensions.width}
            height={event.data.webinar_image.dimensions.height}
            className="w-full h-80 object-cover transition-all duration-300 ease-out sm:h-80 lg:h-96 group-hover:scale-110"
          />
        </div>
        <div
          className="flex justify-start items-center absolute left-6 top-6 gap-1.5 px-3 py-2 rounded-lg bg-white"
        >
          <p
        ...
        >
          ...
          >
            <div
              className="w-12 h-8 absolute left-1.5 top-0 border-t-0 border-r-0 border-b border-l-0 border-[#e6e6e6]"
            >
          ...
          <div
            className="flex flex-col h-full w-[100px] justify-start items-start flex-grow relative gap-3"
          >
            <span
              className={classNames(
            ...
            >
              <div
                className="flex justify-start items-center self-stretch overflow-hidden group rounded-xl gap-4 font-bold lg:font-normal"
              >
                <CalendarIcon />
              ...
              <div
                className="flex justify-start items-center self-stretch relative gap-4"
              >
                <LocationIcon />
                <div
                  className="flex justify-start items-start text-sm lg:text-base text-left relative font-bold lg:font-normal"
                >
              ...
              <div
                className="flex justify-start items-center self-stretch relative gap-4 font-bold lg:font-normal"
              >
                <MoneyIcon />
