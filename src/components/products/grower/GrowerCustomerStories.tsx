...
import GrowerCustomerStoriesBody from "./GrowerCustomerStoriesBody";

const GrowerCustomerStories = ({ data }: { data: IPrismicData }) => {
    ...
    <div className="md:py-10 lg:py-5">
      {stories && stories.length > 0 && (
        <>
          ...
          />
          <GrowerCustomerStoriesBody stories={stories} />
...
export default GrowerCustomerStories;
