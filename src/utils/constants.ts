...
export const BUYER_SERVICE = import.meta.env.PUBLIC_BUYER_SERVICE;
export const GROWER_SERVICE = import.meta.env.PUBLIC_GROWER_SERVICE;
export const VENDOR_SERVICE = import.meta.env.PUBLIC_VENDOR_SERVICE;
